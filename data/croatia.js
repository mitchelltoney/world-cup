...
window.TEAMS.croatia = {
  ...
  players: [
    {id:"livakovic", name:"Livaković", full:"Dominik Livaković", num:1, pos:"Goalkeeper", club:"Girona", rating:7.4, fifa:83,
    ...
    {id:"stanisic", name:"Stanišić", full:"Josip Stanišić", num:18, pos:"Right Back", club:"Bayern Munich", rating:7.3, fifa:81,
     x:84, y:73, skin:"#ecc096", hair:"#5b3a24", style:"crop",
    ...
    {id:"sutalo", name:"Šutalo", full:"Joško Šutalo", num:5, pos:"Centre Back", club:"Ajax", rating:7.0, fifa:79,
    ...
    {id:"pongracic", name:"Pongračić", full:"Marin Pongračić", num:21, pos:"Centre Back", club:"Fiorentina", rating:7.0, fifa:79,
     x:37, y:76, skin:"#ecc096", hair:"#2a1a0e", style:"fade",
    ...
    {id:"gvardiol", name:"Gvardiol", full:"Joško Gvardiol", num:20, pos:"Left Back", club:"Manchester City", rating:8.4, fifa:86,
     x:16, y:73, skin:"#ecc096", hair:"#2a1a0e", style:"headband",
    ...
    {id:"kovacic", name:"Kovačić", full:"Mateo Kovačić", num:8, pos:"Defensive Midfield", club:"Manchester City", rating:8.0, fifa:85,
     x:50, y:57, skin:"#ecc096", hair:"#15100c", style:"bald",
    ...
    {id:"modric", name:"Modrić (C)", full:"Luka Modrić", num:10, pos:"Central Midfield · Captain", club:"AC Milan", rating:8.3, fifa:85,
     x:68, y:52, skin:"#f2cfa6", hair:"#caa24a", style:"flow",
    ...
    {id:"pasalic", name:"Pašalić", full:"Mario Pašalić", num:15, pos:"Central Midfield", club:"Atalanta", rating:7.4, fifa:81,
    ...
    {id:"baturina", name:"Baturina", full:"Martin Baturina", num:11, pos:"Right Wing", club:"Como", rating:7.3, fifa:79,
     x:82, y:28, skin:"#ecc096", hair:"#2a1a0e", style:"crop",
    ...
    {id:"budimir", name:"Budimir", full:"Ante Budimir", num:17, pos:"Striker", club:"Osasuna", rating:7.2, fifa:80,
     x:50, y:20, skin:"#ecc096", hair:"#2a1a0e", style:"fade",
    ...
    {id:"kramaric", name:"Kramarić", full:"Andrej Kramarić", num:9, pos:"Left Wing", club:"Hoffenheim", rating:7.6, fifa:82,
     x:18, y:28, skin:"#ecc096", hair:"#5b3a24", style:"sidepart",
  ...
  depth: [
    {id:"kotarski", name:"Kotarski", full:"Dominik Kotarski", num:12, pos:"Goalkeeper", club:"PAOK", rating:6.8, fifa:77,
    ...
    {id:"juranovic", name:"Juranović", full:"Josip Juranović", num:22, pos:"Right Back", club:"Union Berlin", rating:7.1, fifa:79,
    ...
    {id:"erlic", name:"Erlić", full:"Martin Erlić", num:6, pos:"Centre Back", club:"Sassuolo", rating:6.9, fifa:79,
     x:37, y:76, skin:"#ecc096", hair:"#2a1a0e", style:"crop",
    ...
    {id:"sosa", name:"Sosa", full:"Borna Sosa", num:3, pos:"Left Back", club:"Ajax", rating:7.0, fifa:80,
    ...
    {id:"sucic", name:"Sučić", full:"Luka Sučić", num:14, pos:"Central Midfield", club:"Real Sociedad", rating:7.2, fifa:80,
     x:50, y:57, skin:"#ecc096", hair:"#2a1a0e", style:"fade",
    ...
    {id:"vlasic", name:"Vlašić", full:"Nikola Vlašić", num:13, pos:"Attacking Midfield", club:"Torino", rating:7.1, fifa:81,
    ...
    {id:"perisic", name:"Perišić", full:"Ivan Perišić", num:4, pos:"Winger", club:"Hajduk Split", rating:7.2, fifa:82,
    ...
    {id:"matanovic", name:"Matanović", full:"Igor Matanović", num:19, pos:"Striker", club:"SC Freiburg", rating:6.9, fifa:76,
     x:50, y:20, skin:"#ecc096", hair:"#2a1a0e", style:"crop",
